...
class DbLike extends Logging  {
  ...
  def query_db(sql:String, params:ArrayBufferString, keyTypes:ArrayBuffer[Int], masterList: ArrayBuffer[DataSource], slaveList: ArrayBuffer[DataSource], dbIdx:Int):DbResults = {
