...
rem call scalac -deprecation -encoding UTF-8 -cp ".\lib\*;." -d ".\classes"   src\plugin\http\*.scala  
copy /Y src\plugin\scalabpe.plugins.conf .\classes\  2>>nul 1>>nul 
