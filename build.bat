...
rem call scalac -deprecation -encoding UTF-8 -cp ".\lib\*;.\lib\log\*;." -d ".\classes"   src\scalabpe\core\*.scala src\scalabpe\plugin\*.scala src\scalabpe\plugin\http\*.scala src\scalabpe\plugin\cache\*.scala
call scalac -deprecation -encoding UTF-8 -cp ".\lib\*;." -d ".\classes"   src\scalabpe\plugin\http\*.scala
